...
const Blogs = () => {
          ...
          <a  className="max-w-sm mx-auto group hover:no-underline focus:no-underline ">
          ...
          <a  className="max-w-sm mx-auto group hover:no-underline focus:no-underline  hidden sm:block">
